...
>
            ...
            <div className="absolute inset-0 bg-[#5C469C] bg-opacity-90 opacity-0 group-hover:opacity-100 group-focus:opacity-100 transition-opacity duration-300 flex items-center justify-center p-4">
  <p className="text-white text-center text-sm font-medium">{partner.description}</p>
</div>
        ...
        {Array.from({ length: totalPages }).map((_, i) => (
          <span
            ...
            className={`h-3 w-3 rounded-full cursor-pointer ${
              i === currentIndex ? "bg-[#5C469C]" : "bg-gray-300"
            }`}
